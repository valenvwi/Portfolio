        ...
        <div className="col-sm-12 col-md-8 container d-flex justify-content-center align-items-center">
          <div className="ml-2">
            ...
            <p className="lead">
              ...
              fast-paced world. With just a few taps on your smartphone, you can
              send or receive packages on time and with complete transparency.
              Originally, this was a two-week student project made by Wai Ian
              Vong, Micaela Frigola, Mayavi Steiner and Corinna Grundmeier. I
              have added additional pages to complete the driver's journey,
              edited validations for orders, and add-ons to improve the user's
              journey.
            </p>
            <h5>Tech-Stack</h5>
            <div className="row">
